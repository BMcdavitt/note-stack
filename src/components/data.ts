...
export const NotebookChapters: INotebookChapter[] = [
  ...
  { id: 9, title: 'Quick Workbook', notes: undefined, childChapters: [], notebookId: 2 },
  { id: 10, title: 'Good Ideas', notes: undefined, childChapters: [11, 12], notebookId: 3 },
  { id: 11, title: 'Idea 1', notes: undefined, childChapters: [] },
  { id: 12, title: 'Idea 2', notes: undefined, childChapters: [] },
  { id: 13, title: 'Bad Ideas', notes: undefined, childChapters: [14], notebookId: 3 },
  { id: 14, title: 'Idea 1', notes: undefined, childChapters: [] },
  { id: 15, title: 'Good Dreams', notes: undefined, childChapters: [], notebookId: 4 },
  { id: 16, title: 'Bad Dreams', notes: undefined, childChapters: [], notebookId: 4 },
